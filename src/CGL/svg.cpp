...
// Draw routines //
    ...
    void Triangle::draw(RayTracer *dr, Matrix3x3 global_transform) {
 ...
 */
    Color ColorTri::color(Vector3D p_bary, Vector3D p_dx_bary, Vector3D p_dy_bary, SampleParams sp) {
        // Part 4: Fill this in.
        Color c;
        c = p_bary[0]*p0_col + p_bary[1]*p1_col + p_bary[2]*p2_col;
        c.a = 1;
        return c;
    }
 ...
 */
    ...
    void Group::draw(RayTracer *dr, Matrix3x3 global_transform) {
        global_transform = global_transform * transform;
    ...
    void Rect::draw(RayTracer *dr, Matrix3x3 global_transform) {
        global_transform = global_transform * transform;
    ...
    void Polygon::draw(RayTracer *dr, Matrix3x3 global_transform) {
        global_transform = global_transform * transform;
    ...
    void Image::draw(RayTracer *dr, Matrix3x3 global_transform) {
        global_transform = global_transform * transform;
